...
async def _py(client: Client, message: Message):
    await message.reply_text('**Hey Ben Uslanmaz Tagger Bot, .** \n __Sahibim __ = Leron Beni Siz Kullanın Diye Yapti💋🤕')
...
async def hg(bot: Client, msg: Message):
    for new_user in msg.new_chat_members:
        if str(new_user.id) == str(Config.BOT_ID):
            ...
            await msg.reply('İşte bu gelen benim sahibim Hoşgeldin Sahip 😎🤠.')
